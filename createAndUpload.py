...
test_emails=["edgeboi@gmail.com", "stephmorel8910@gmail.com", "step@gmail.com", "team@hackphs.tech"]

properties=["dateCreated", "fullName", "isFullyLoggedIn", "shirtSize", "school", "specialAccomadations", "dietaryRestrictions", "phone", "graduationYear", "latino", "ethnicity", "gender", "studyLevel", "email", "resumeLink"]
...
sheet = client.open("Signups 2019").sheet1
# Select a cell range
allCells=sheet.range("A1:O"+str(len(csv)))
